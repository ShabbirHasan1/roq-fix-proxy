...
void Session::operator()(Trace<fix_bridge::fix::ResendRequest> const &event, roq::fix::Header const &) {
  auto &[trace_info, resend_request] = event;
  log::debug("resend_request={}, trace_info={}"sv, resend_request, trace_info);
}

void Session::operator()(Trace<fix_bridge::fix::Logon> const &event, roq::fix::Header const &) {
...
void Session::operator()(Trace<fix_bridge::fix::Logout> const &event, roq::fix::Header const &) {
...
void Session::operator()(Trace<fix_bridge::fix::Heartbeat> const &event, roq::fix::Header const &) {
  auto &[trace_info, heartbeat] = event;
  log::debug("heartbeat={}, trace_info={}"sv, heartbeat, trace_info);
}

void Session::operator()(Trace<fix_bridge::fix::TestRequest> const &event, roq::fix::Header const &) {
...
void Session::operator()(Trace<fix_bridge::fix::BusinessMessageReject> const &event, roq::fix::Header const &) {
...
void Session::operator()(Trace<fix_bridge::fix::SecurityList> const &event, roq::fix::Header const &) {
...
void Session::operator()(Trace<fix_bridge::fix::SecurityDefinition> const &event, roq::fix::Header const &) {
  auto &[trace_info, security_definition] = event;
  log::debug("security_definition={}, trace_info={}"sv, security_definition, trace_info);
  handler_(event);
}

void Session::operator()(Trace<fix_bridge::fix::MarketDataRequestReject> const &event, roq::fix::Header const &) {
...
void Session::operator()(Trace<fix_bridge::fix::MarketDataSnapshotFullRefresh> const &event, roq::fix::Header const &) {
...
void Session::operator()(Trace<fix_bridge::fix::MarketDataIncrementalRefresh> const &event, roq::fix::Header const &) {
...
void Session::operator()(Trace<fix_bridge::fix::OrderCancelReject> const &event, roq::fix::Header const &) {
  auto &[trace_info, order_cancel_reject] = event;
  log::debug("order_cancel_reject={}, trace_info={}"sv, order_cancel_reject, trace_info);
  handler_(event, username_);
}

void Session::operator()(Trace<fix_bridge::fix::ExecutionReport> const &event, roq::fix::Header const &) {
